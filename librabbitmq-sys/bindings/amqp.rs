...
pub const AMQP_VERSION_PATCH: ::std::os::raw::c_uint = 1;
pub const AMQP_VERSION_IS_RELEASE: ::std::os::raw::c_uint = 0;
...
pub const AMQP_DEFAULT_VHOST: &'static [u8; 2usize] = b"/\0";
...
extern "C" {
    pub fn amqp_get_handshake_timeout(state: amqp_connection_state_t) -> *mut timeval;
}
extern "C" {
    pub fn amqp_set_handshake_timeout(
        state: amqp_connection_state_t,
        timeout: *mut timeval,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn amqp_get_rpc_timeout(state: amqp_connection_state_t) -> *mut timeval;
}
extern "C" {
    pub fn amqp_set_rpc_timeout(
        state: amqp_connection_state_t,
        timeout: *mut timeval,
    ) -> ::std::os::raw::c_int;
}
